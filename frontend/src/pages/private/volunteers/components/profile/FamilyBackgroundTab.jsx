...
const FamilyBackgroundTab = ({ user }) => {
  return (
    <div className="space-y-4">
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-600">Number of Siblings</label>
              <p className="text-gray-900 font-medium">{user?.familyBackground?.numberOfSiblings || 'Not provided'}</p>
            </div>
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-600">Position in Family</label>
              <p className="text-gray-900 font-medium">{user?.familyBackground?.positionInFamily || 'Not provided'}</p>
            </div>
          </div>
        </CardContent>
      </Card>
